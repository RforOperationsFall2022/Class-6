...
ckanUniques <- function(id, field) {
  url <- paste0("https://data.wprdc.org/api/action/datastore_search_sql?sql=SELECT%20DISTINCT(%22", field, "%22)%20from%20%22", id, "%22%20WHERE%20%22CREATED_ON%22%20BETWEEN%20%27", Sys.Date()-30, "%27%20AND%20%27", Sys.Date(), "%27")
  ckanSQL(url)
}
